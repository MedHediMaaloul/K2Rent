...
var FullCalendar = (function (exports) {
            ...
            if (handleCustomRendering) {
                ...
                if (generatorMeta) {
                    handleCustomRendering(Object.assign(Object.assign({
                        id: this.id, isActive, containerEl: this.base, reportNewContainerEl: this.handleEl, // for customRenderingReplacesEl
                        generatorMeta
    ...
    */
    ...
    class ViewContainer extends BaseComponent {
        render() {
            ...
            return (h(ContentContainer, Object.assign({}, props, {
    ...
    */
    ...
    class TableDowCell extends BaseComponent {
        render() {
            ...
            }, (InnerContent) => (h("div", { className: "fc-scrollgrid-sync-inner" },
                h(InnerContent, {
                    elTag: "a", elClasses: [
                        'fc-col-header-cell-cushion',
                        props.isSticky && 'fc-sticky',
    ...
    */
    ...
    class EventContainer extends BaseComponent {
        ...
        render() {
            ...
            return (h(ContentContainer, Object.assign({}, props /* contains children */, {
    ...
    class StandardEvent extends BaseComponent {
        render() {
            ...
            return (h(EventContainer, Object.assign({}, props /* includes elRef */, {
                elTag: "a", elStyle: {
                    borderColor: ui.borderColor,
                    backgroundColor: ui.backgroundColor,
                }, elAttrs: getSegAnchorAttrs(seg, context), defaultGenerator: renderInnerContent$1$1, timeText: timeText
            }), (InnerContent, eventContentArg) => (h(p, null,
    ...
    class DayCellContainer extends BaseComponent {
        ...
        render() {
            ...
            return (h(ContentContainer, Object.assign({}, props /* includes children */, {
                elClasses: [
    ...
    class MoreLinkContainer extends BaseComponent {
        ...
        render() {
            ...
            return (h(ViewContextType.Consumer, null, (context) => {
                ...
                return (h(p, null,
                    Boolean(props.moreCnt) && (h(ContentContainer, {
                    ...
                    state.isPopoverOpen && (h(MorePopover, {
                        id: state.popoverId, startDate: range.start, endDate: range.end, dateProfile: props.dateProfile, todayRange: props.todayRange, extraDateSpan: props.extraDateSpan, parentEl: this.parentEl, alignmentEl: props.alignmentElRef ?
                            ...
                            this.linkEl, alignGridTop: props.alignGridTop, onClose: this.handlePopoverClose
    ...
    */
    ...
    const MINIMAL_RAW_EN_LOCALE = {
        ...
        timeHint: 'Time',
        eventHint: 'Event',
        allDayText: 'CONTRAT DE LOCATION VEHICULE N°',
        moreLinkText: 'more',
    ...
    */
    ...
    class TableCelle extends DateComponent {
        constructor() {
            super(...arguments);
            this.rootElRef = y();
            this.state = {
    ...
    class TableCell extends DateComponent {
        ...
        render() {
            ...
            }, (InnerContent, renderProps) => (h("div", { ref: props.innerElRef, className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", style: { minHeight: props.minHeight } },
                props.showWeekNumber && (h(WeekNumberContainer, { elTag: "a", elClasses: ['fc-daygrid-week-number'], elAttrs: buildNavLinkAttrs(context, date, 'week'), date: date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT$1 })),
                !renderProps.isDisabled &&
    ...
    class TableRowe extends DateComponent {
        constructor() {
            super(...arguments);
    ...
    class TableRowse extends DateComponent {
        constructor() {
            super(...arguments);
        ...
        render() {
            ...
            let cellMinHeight = (rowCnt >= 7 && props.clientWidth) ?
                ...
                null;
            return (h(NowTimer, { unit: "day" }, (nowDate, todayRange) => (h(p, null, props.cells.map((cells, row) => (h(TableRowe, {
    ...
    class TableRows extends DateComponent {
        ...
        render() {
            ...
            let cellMinHeight = (rowCnt >= 7 && props.clientWidth) ?
                props.clientWidth / context.options.aspectRatio / 6 :
                null;
            return (h(NowTimer, { unit: "day" }, (nowDate, todayRange) => (h(p, null, props.cells.map((cells, row) => (h(TableRow, {
                ref: this.rowRefs.createRef(row), key: cells.length
                    ? cells[0].date.toISOString() /* best? or put key on cell? or use diff formatter? */
                    : row // in case there are no cells (like when resource view is loading)
                , showDayNumbers: rowCnt > 1, showWeekNumbers: props.showWeekNumbers, todayRange: todayRange, dateProfile: props.dateProfile, cells: cells, renderIntro: props.renderRowIntro, businessHourSegs: businessHourSegsByRow[row], eventSelection: props.eventSelection, bgEventSegs: bgEventSegsByRow[row].filter(isSegAllDay) /* hack */, fgEventSegs: fgEventSegsByRow[row], dateSelectionSegs: dateSelectionSegsByRow[row], eventDrag: eventDragByRow[row], eventResize: eventResizeByRow[row], dayMaxEvents: props.dayMaxEvents, dayMaxEventRows: props.dayMaxEventRows, clientWidth: props.clientWidth, clientHeight: props.clientHeight, cellMinHeight: cellMinHeight, forPrint: props.forPrint
    ...
    class Tablee extends DateComponent {
        constructor() {
            super(...arguments);
            this.elRef = y();
            ...
            return (h("div", {
                ...
                h("table", {
                    ...
                    h("tbody", { role: "presentation" },
                        h(TableRowse, { dateProfile: props.dateProfile, cells: props.cells, renderRowIntro: props.renderRowIntro, showWeekNumbers: props.showWeekNumbers, clientWidth: props.clientWidth, clientHeight: props.clientHeight, businessHourSegs: props.businessHourSegs, bgEventSegs: props.bgEventSegs, fgEventSegs: props.fgEventSegs, dateSelectionSegs: props.dateSelectionSegs, dayMaxEvents: dayMaxEvents, dayMaxEventRows: dayMaxEventRows, forPrint: props.forPrint, isHitComboAllowed: props.isHitComboAllowed })))));
        }
        componentDidMount() {
    ...
    class DayTablee extends DateComponent {
        constructor() {
            super(...arguments);
    ...
    class DayTableViewe extends TableView {
        constructor() {
            super(...arguments);
    ...
    function TimeColsAxisCell(props) {
        ...
        return (h(ViewContextType.Consumer, null, (context) => {
            ...
            }, (InnerContent) => (h("div", { className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame" },
                h(InnerContent, {
                    elTag: "div", elClasses: [
    ...
    */
        ...
        render() {
            ...
            return (h(MoreLinkContainer, {
                elClasses: ['fc-timegrid-more-link'], elStyle: {
                    top: props.top,
                    bottom: props.bottom,
                }, allDayDate: null, moreCnt: props.hiddenSegs.length, allSegs: props.hiddenSegs, hiddenSegs: props.hiddenSegs, extraDateSpan: props.extraDateSpan, dateProfile: props.dateProfile, todayRange: props.todayRange, popoverContent: () => renderPlainFgSegs(props.hiddenSegs, props), defaultGenerator: renderMoreLinkInner
            }, (InnerContent) => (h(InnerContent, { elTag: "div", elClasses: ['fc-timegrid-more-link-inner', 'fc-sticky'] }))));
        }
    }
    ...
    class TimeColEvent extends BaseComponent {
        render() {
            return (h(StandardEvent, Object.assign({}, this.props, {
                elClasses: [
                    'fc-timegrid-event',
                    'fc-v-event',
    ...
    class TimeCol extends BaseComponent {
        ...
        render() {
            ...
            }, (InnerContent) => (h("div", { className: "fc-timegrid-col-frame" },
    ...
    class DayTimeColsViewe extends TimeColsView {
        constructor() {
            super(...arguments);
    ...
    class ListViewEventRow extends BaseComponent {
        render() {
            ...
            return (h(EventContainer, Object.assign({}, props, {
                elTag: "tr", elClasses: [
                    'fc-list-event',
